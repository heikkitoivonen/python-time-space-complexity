...
```
Geometric mean: ~25% faster across benchmarks (pyperformance)
...
# - binhex module
# - random.shuffle(..., random=...) parameter

# Deprecated / pending removal:
# - asyncore, asynchat, smtpd (removed in 3.12)
# - PEP 594 modules (removed in 3.13)
...
# Code often runs faster automatically
# No changes needed!
...
# 3.10: baseline
# 3.11: typically faster (workload-dependent)
```
